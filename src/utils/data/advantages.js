...
const advantages = [
  ...
  },
  {
    ...
    src: homePath,
    content:
      'Мастера выезжают на дом по городу Липецку и Липецкой области. Стоимость диагностики 500 рублей. Если ремонт выполняет наш мастер, то диагностика производится бесплатно. Цена 1 км пути за пределами города Липецка составляет 20 рублей.',
  },
  {
    id: 3,
  ...
  },
  {
    ...
    src: timePath,
    content:
      'Сервисный центр NON-STOP работает без выходных, с 9:00 до 22:00 ежедневно, поэтому Вы имеете возможность договориться с мастером об удобном для Вас времени проведения ремонтных работ.',
  },
  {
    id: 5,
