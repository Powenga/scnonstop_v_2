...
export default function Map({ classes, children }) {
  ...
  useEffect(() => {
    ...
    script.src =
      'https://api-maps.yandex.ru/services/constructor/1.0/js/?um=constructor%3A33c502b48dd06ce3a0b1c8f51f3b7cdc3abebba80a2fec1cd1728e79e24abcef&amp;width=100%25&amp;height=550&amp;lang=ru_RU&amp;scroll=true';
    script.async = true;
