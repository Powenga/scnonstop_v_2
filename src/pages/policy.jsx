      ...
      >
        <div className="app__container app__container_type_policy">
          ...
          <p className="main-text main-text_paragraph">
            ...
            данных компании NON-STOP в лице индивидуального предпринимателя
            Ананьева Ильи Николаевича (далее – Оператор).
          </p>
          <p className="main-text main-text_paragraph">
          ...
          <p className="main-text main-text_paragraph">
            1.3. Настоящая политика Оператора в отношении обработки персональных
            данных (далее – Политика) применяется ко всей информации, которую
            Оператор может получить о посетителях веб-сайта: www.scnonstop.ru.
          </p>
          <h3 className="main-text main-text_paragraph main-text_large">
            {' '}
          ...
          <p className="main-text main-text_paragraph">
            ...
            доступность в сети интернет по сетевому адресу www.scnonstop.ru.
          </p>
          <p className="main-text main-text_paragraph">
          ...
          <p className="main-text main-text_paragraph">
            2.9. Пользователь – любой посетитель веб-сайта www.scnonstop.ru .
          </p>
          <p className="main-text main-text_paragraph">
          ...
          <p className="main-text main-text_paragraph">3.1. Фамилия</p>
          <p className="main-text main-text_paragraph">3.2. Имя</p>
          <p className="main-text main-text_paragraph">3.3. Номер телефона</p>
          <p className="main-text main-text_paragraph">
            3.4. Адрес электронной почты
          </p>
          <p className="main-text main-text_paragraph">
            3.5. Адрес проживания или нахождения техники, требующей ремонта
          </p>
          <p className="main-text main-text_paragraph">
            3.6. Описание проблемы, наименование и модель техники
          </p>
          <p className="main-text main-text_paragraph">
            3.7. Также на сайте происходит сбор и обработка обезличенных данных
            о посетителях (в т.ч. файлов «cookie») с помощью сервисов
            интернет-статистики (Яндекс Метрика и Гугл Аналитика и других).
          </p>
          <p className="main-text main-text_paragraph">
            3.8. Вышеперечисленные данные далее по тексту Политики объединены
          ...
          <p className="main-text main-text_paragraph">
            4.1. Цель обработки персональных данных Пользователя — оформление
            заявки на сайте www.scnonstop.ru для передачи этих данных третьим
            лицам в целях обратной связи и выполнения работ по изложенной
            Пользователем проблеме.
          </p>
          <p className="main-text main-text_paragraph">
            Заполняя соответствующие формы и/или отправляя свои персональные
            данные Оператору, Пользователь выражает свое согласие с передачей
            Персональных данных третьим лицам в целях, изложенных в настоящем
            пункте.
          </p>
          <p className="main-text main-text_paragraph">
            ...
            электронной почты order@scnonstop.ru с пометкой «Отказ от
          ...
          <p className="main-text main-text_paragraph">
            ...
            через специальные формы, расположенные на сайте www.scnonstop.ru.
            Заполняя соответствующие формы и/или отправляя свои персональные
          ...
          <p className="main-text main-text_paragraph">
            6.3. Персональные данные Пользователя никогда, ни при каких условиях
          ...
          <p className="main-text main-text_paragraph">
            ...
            Пользователь может актуализировать их самостоятельно в Личном
          ...
          <p className="main-text main-text_paragraph">
            ...
            order@scnonstop.ru с пометкой «Отзыв согласия на обработку
            персональных данных».
          </p>
          <h3 className="main-text main-text_paragraph main-text_large">
            {' '}
          ...
          <p className="main-text main-text_paragraph">
            ...
            к Оператору с помощью электронной почты order@scnonstop.ru.
          </p>
          <p className="main-text main-text_paragraph">
          ...
          <p className="main-text main-text_paragraph">
            ...
            сети Интернет по адресу www.scnonstop.ru/policy.
          </p>
        </div>
      </section>
    </main>
